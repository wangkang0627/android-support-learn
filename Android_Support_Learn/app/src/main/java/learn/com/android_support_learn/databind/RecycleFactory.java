 ...
 * @Description: recyclerView layoutManager创建工厂
 * @Author wk
 * @Date 2015/9/4 0004
 */
public class RecycleFactory {
    public static final int LINEAROUTMANAGER = 0;
    public static final int GRIDMANAGER = 1;
    public static final int STAGGEREDGRIDMANAGER = 2;
    private int type;
    @BindingAdapter("layoutManager")
    public static void setLayoutManager(RecyclerView recyclerView, LayoutManagerFactory layoutManagerFactory) {
    ...
    private RecycleFactory(int type) {

    }

    public static RecycleFactory.LayoutManagerFactory linear() {
        return new RecycleFactory.LayoutManagerFactory() {
            @Override
